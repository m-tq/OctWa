...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-sm font-bold leading-none tracking-wide text-primary',
      className
    )}
    {...props}
  />
